create table public.floral_proposals (
  ...
  -- Nullable for direct SignWell delivery. Historical portal records retain their hashes.
  passcode_hash text null,
  pdf_storage_path text null,
  pdf_url text null,
  canva_pdf_storage_path text null,
  canva_pdf_file_name text null,
  combined_pdf_storage_path text null,
  combined_pdf_file_name text null,
  contract_template_source text null,
  contract_template_revision text null,
  signing_provider text null,
  signing_status text null default 'not_started'::text,
  signing_session_reference text null,
  signed_package_storage_path text null,
  signing_completed_at timestamp with time zone null,
  signing_declined_at timestamp with time zone null,

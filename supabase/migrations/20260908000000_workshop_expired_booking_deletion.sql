-- Additive CRM roster refinement. Expired abandoned bookings may be deleted by
-- internal users while immutable financial, communication, privacy, and
-- rescheduling history remains protected.
...
-- Rollback: revoke/drop only delete_expired_workshop_booking(uuid, uuid).

-- Re-establish the targeted delivery claim boundary for environments where the
-- immediate-dispatch migration was skipped or PostgREST retained a stale schema.

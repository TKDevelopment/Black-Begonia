-- Extend the guarded roster deletion command to clean cancelled bookings that
-- have no protected financial, communication, privacy, or rescheduling history.
...
-- 20260908000000_workshop_expired_booking_deletion.sql.

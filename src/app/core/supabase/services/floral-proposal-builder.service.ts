...
export class FloralProposalBuilderService {
  ...
  createEmptyComponentRow(
    ...
    return {
      ...
      extended_quantity: 0,
      base_unit_cost: 0,
      applied_markup_percent: pricingSettings?.default_markup_percent ?? 300,
      sell_unit_price: 0,
      subtotal: 0,
      reserve_percent: pricingSettings?.default_reserve_percent ?? 3,
      item_type: null,
      unit_type: null,
      color: null,
      variety: null,
  ...
  applyCatalogItemToComponent(
    ...
    const appliedMarkupPercent =
      ...
      pricingSettings?.default_markup_percent ??
      300;
    const reservePercent =
      component.reserve_percent ??
      pricingSettings?.default_reserve_percent ??
      3;

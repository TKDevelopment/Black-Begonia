...
describe('production environment', () => {
  ...
  it('keeps deploy-time placeholders for externally supplied keys', () => {
    ...
    expect(environment.ga4MeasurementId === '' || /^G-[A-Z0-9]+$/i.test(environment.ga4MeasurementId)).toBeTrue();
  ...
  it('cannot carry privileged payment, email, encryption, or automation secrets', () => {
    ['stripeSecretKey', 'stripeWebhookSecret', 'paypalClientSecret', 'paypalWebhookId', 'mailgunApiKey', 'mailgunSigningKey', 'paymentTokenEncryptionKey', 'supabaseServiceRoleKey', 'paymentAutomationKey', 'googleAnalyticsApiSecret']
